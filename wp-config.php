...
define('DB_NAME', 'allergyAllies');
//define('DB_NAME', 'site0040_wrdp1');

/** MySQL database username */
define('DB_USER', 'root');
//define('DB_USER', 'site0040_wrdp1');

/** MySQL database password */
define('DB_PASSWORD', '');
//define('DB_PASSWORD', 'iZ35utv1YHxcUhpO');
...
$base = '/allergy-WP/';
define( 'DOMAIN_CURRENT_SITE', 'dev.elocalhost.com' );
define( 'PATH_CURRENT_SITE', '/allergy-WP/' );
